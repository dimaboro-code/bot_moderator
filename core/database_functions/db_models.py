...
class User(Base):
    ...
    user_id: Mapped[int] = mapped_column(Numeric, unique=True, nullable=True)
...
class Mute(Base):
    ...
    message_id: Mapped[int] = mapped_column(Numeric, nullable=True)
...
class Id(Base):
    ...
    user_id: Mapped[int] = mapped_column(Numeric, nullable=True)
